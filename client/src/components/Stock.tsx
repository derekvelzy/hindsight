...
const colors: {} = [
  ...
  },
  {
    ...
    hov:
      "linear-gradient(to bottom right, rgb(233, 112, 118), rgb(233, 113, 227))",
  },
  {
    static: "rgb(241, 231, 88)",
    hov:
      "linear-gradient(to bottom right, rgb(241, 231, 88), rgb(193, 226, 100))",
  },
  {
    static: "rgb(112, 233, 173)",
    hov:
      "linear-gradient(to bottom right, rgb(112, 233, 173), rgb(113, 161, 233))",
  },
  {
    static: "rgb(255, 110, 84)",
    hov:
      "linear-gradient(to bottom right, rgb(255, 110, 84), rgb(245, 61, 61))",
  },
  {
    static: "rgb(114, 112, 233)",
    hov:
      "linear-gradient(to bottom right, rgb(114, 112, 233), rgb(169, 113, 233))",
  },
  {
    static: "rgb(233, 181, 112)",
    hov:
      "linear-gradient(to bottom right, rgb(233, 181, 112), rgb(233, 131, 113))",
  },
  {
    static: "rgb(233, 225, 112)",
    hov:
      "linear-gradient(to bottom right, rgb(233, 225, 112), rgb(113, 233, 227))",
  },
  {
    static: "rgb(88, 241, 170)",
    hov:
      "linear-gradient(to bottom right, rgb(88, 241, 170), rgb(79, 224, 200))",
  },
];
...
const Stock: React.FC<Props> = ({
  ...
  const percent = percentString.substring(0, percentString.indexOf(".") + 3);
  ...
  return (
    <div className={styles.stockContainer}>
      ...
      >
        <div>
          <div className={styles.titleAndShares} style={{}}>
            <Link
              ...
              style={{
                background: hover
                  ? colors[colorID || 0].static
                  : colors[colorID || 0].hov,
              }}
            >
          ...
          <button className={styles.tradeButton} onClick={() => setVis(!vis)}>
            trade
          </button>
        </div>
      </div>
      <div
        ...
        style={{
          marginBottom: vis ? "0px" : "-150px",
          transition: "all 0.3s ease",
          background: colors[colorID || 0].hov,
        }}
      >
        <div className={styles.tradeContents}>
          ...
          >
            <div style={{ color: "white", fontSize: "22px" }}>
              $
              {buyVal !== ""
                ? multStrings(buyVal, stock.data[99].cost)
                : multStrings(sellVal, stock.data[99].cost)}
            </div>
            <button
